...
namespace Wind {
  public partial class InputSystem {
    ...
    public static Keys CreateKeys() => new Keys(new KeyEqualityComparer());
    ...
    public struct Trigger(string name, Keys bindings, Callbacks callbacks) {
      ...
      public Trigger(string name, Keys bindings) : this(name, bindings, new Callbacks(delegate { })) { }
      public Trigger(string name, Callbacks callbacks) : this(name, CreateKeys(), callbacks) { }
      public Trigger(string name) : this(name, CreateKeys(), new Callbacks(delegate { })) { }
    };
  }
}
